...
dc
  ...
  --o corrmap-o 
    => --o corrmap-o [w/a] ( a = append / w or none = over-write ) 
    => 出力補正マップへの追記は引数で指定する。
	
ali
  --dif corrmap-dif を廃止
  --c corrmap-o => --c corrmap-o [w/a] ( a = append / w or none = over-write ) 
    => 出力補正マップへの追記は引数で指定する。
...
ali-g
  --pc corrma-pc を廃止
  --dif corrmap-dif を廃止
  --search-mode 1/2 corrmap-i => search-mode = 2 でも corrmap-i 指定可能、上記 --pc の代替
